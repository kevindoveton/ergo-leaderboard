...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getTeams = function (eventId) {
        var teamUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + '/teams';
        return this.http
            .get(teamUrl, {
    ...
    ApiService.prototype.addTime = function (user, time, event) {
        ...
        if (typeof user.Team === 'number' || user.Team.id) {
            teamObs = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"](function (obs) {
                obs.next({
        ...
        return teamObs.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (team) {
...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1)).subscribe(function (el) {
            ...
            _this.api.getTeams(el.id).subscribe(function (ev) {
                _this.teams = ev;
            });
        });
    };
    ...
    SignupComponent.prototype.submit = function () {
        ...
        var teamId;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.teams), _c = _b.next(); !_c.done; _c = _b.next()) {
                var team = _c.value;
    ...
    SignupComponent.prototype.chooseTeam = function () {
...
var TeamSelectionComponent = /** @class */ (function () {
    ...
    TeamSelectionComponent.prototype.newTeam = function () {
        this.teamChange.emit(this.newTeamVal);
    };
    TeamSelectionComponent.prototype.changeTeam = function (team) {
