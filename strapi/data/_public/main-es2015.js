...
let ApiService = class ApiService {
    ...
    addTime(user, time, event) {
        ...
        // create participant
        // create time
        return this.http.post(teamUrl, user.Team).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((team) => {
